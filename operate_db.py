...
myclient = pymongo.MongoClient("mongodb://traveldb1:LXj2aZHxhqDOOO0kofR8A0yoGQoItuHwSTmZF4QaDvA4aTirII5lRSZRkBzKPreC7WEScYQjijhmACDb46P4RQ==@traveldb1.mongo.cosmos.azure.com:10255/?ssl=true&retrywrites=false&replicaSet=globaldb&maxIdleTimeMS=120000&appName=@traveldb1@")
db = myclient["traveldb1"]
db.users.drop()
# cursor = db.histories.find({'email': 'shabi@gmail.com'})
